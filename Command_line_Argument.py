...
ok no worry open a text file name it like fuck.py ok now write a hello World code and save it somewhere in desktop and now
go to that path and and save the path and your path name will be like this c:/users/Desktop you can find it in properties
ok now run it like this python fuck.py
